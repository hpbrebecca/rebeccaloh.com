...
(function() {
    ...
    const aboutContent = {
        description: {
            de: "Vernetzen Sie sich mit mir auf LinkedIn, um mehr über meine Arbeit zu erfahren.",
            en: "Connect with me on LinkedIn to learn more about my work.",
            fr: "Entrez en contact avec moi sur LinkedIn pour en savoir plus sur mon travail.",
            zh: "在 LinkedIn 上與我建立連結，了解更多關於我的工作。"
        },
        intro: {
            de: "",
            en: "",
        ...
        sections: {
            ...
            de: [
                ...
                },
                {
                    ...
                    paragraphs: [
                        "Nach der Lehre engagierte sie sich ein halbes Jahr freiwillig in Südafrika. In einem internationalen Team mit Menschen aus 16 Nationen erlebte sie, wie Zusammenarbeit und kulturelle Vielfalt Brücken schaffen können. Diese Erfahrung vertiefte ihr Verständnis für Menschen und inspirierte sie, in der Schweiz eine Karriere aufzubauen, die Stabilität schafft und zugleich Chancen für andere eröffnet, auch über Landesgrenzen hinaus.",
                ...
                },
                {
                    ...
                    paragraphs: [
                        "Bevor sie zu FiCAS AG wechselte, arbeitete sie als Teamleiterin Controlling bei der Gemeinde Köniz, als Financial Controller bei der Eidgenössischen Finanzmarktaufsicht (FINMA) sowie bei der iba ag, Büro Services. In allen Positionen wurde sie für ihre lösungsorientierte Haltung, ihr strukturiertes Denken und ihre Fähigkeit geschätzt, komplexe Themen klar und umsetzbar zu gestalten. Sie fördert konstruktive Ergebnisse, indem sie zuhört, Hintergründe versteht und Brücken zwischen unterschiedlichen Perspektiven baut. Ihr nahbarer Führungsstil schuf Vertrauen und förderte Zusammenarbeit.",
                        "Seit August 2024 ist sie Chief Financial Officer der FiCAS AG, einem von der FINMA zugelassenen Schweizer Asset Manager für aktiv verwaltete Krypto-Anlageprodukte. In diesem dynamischen Umfeld verbindet sie ihre Erfahrungen aus öffentlicher Verwaltung und Finanzbranche, gestaltet Prozesse neu und stärkt die Governance, um nachhaltigen Fortschritt zu ermöglichen.",
                        "Rebecca ist bekannt für ihr analytisches Denken und ihre kreative Art, Herausforderungen zu lösen. Elle aime concevoir et perfectionner des processus qui apportent clarté, stabilité et efficacité à long terme, combinant précision et intuition pour transformer la structure en progrès durable."
                    ]
                }
            ],
            fr: [
            ...
            zh: [
                {
                    title: "早年與價值觀",
                    paragraphs: [
                        "Rebecca Loh 出生並成長於瑞士巴塞爾，並在當地完成學業。每天上學的路上，她都會經過街角的一家瑞銀分行，這個日常畫面啟發了她對銀行與投資世界的早期好奇心。她自小便對複利深感著迷，理解價值如何隨時間持續增長。十四歲時，她透過自己的青年帳戶購買了第一檔瑞銀基金，這個起步成為她探索金融市場與投資價值創造的開端。",
                ...
                },
                {
                    title: "全球視野與進修",
                    paragraphs: [
                        "完成學徒後，Rebecca 前往南非參與為期半年的志工服務，與來自十六個國家的成員合作。這段跨文化經驗讓她更理解多樣性與合作的力量，也強化了她在瑞士建立穩定事業的動力，同時希望能創造價值並促進他國的發展機會。",
                ...
                },
                {
                    title: "職涯與專業理念",
                    paragraphs: [
                        "加入 FiCAS AG 之前，Rebecca 曾任柯尼茲市政府控管團隊主管、瑞士金融市場監管局（FINMA）財務控制師，以及 iba ag 財務控制師。她與眾多利害關係人合作，因其包容、務實與能將複雜議題化繁為簡而深受信任。她擅長理解不同觀點、辨識需求並建立橋樑，推動建設性的成果。",
                        "自 2024 年 8 月起，她擔任 FiCAS AG 的首席財務官。FiCAS 為獲 FINMA 認可的瑞士資產管理公司，專注於主動管理的加密資產投資產品。她結合公部門與私人企業的經驗，推動流程優化、強化治理並建立長期價值。",
                        "Rebecca 以清晰的分析思維與創意解題聞名。她專注於設計與完善帶來清晰、穩定與持續效率的流程，結合精準與直覺，讓結構轉化為具體且可持續的進步。"
                    ]
                }
            ]
        },
